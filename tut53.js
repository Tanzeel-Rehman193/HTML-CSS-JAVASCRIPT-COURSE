// const fs = require('fs');
// const text = fs.readFilesync("dele.txt", "utf8");
// console.log(text);
...
#secondpara {
    background-color: rgb(213, 17, 190);
    height: 100px;
    width: 445px;
...
<body>
    ...
    <p id="thirdpara">this is yet another paragraph</p>
